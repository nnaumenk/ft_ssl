...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/03 00:51:34 by nnaumenk          #+#    #+#             */
/*   Updated: 2018/11/15 20:18:44 by nnaumenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_sha512_algor(uint64_t *hash, char *text, size_t len)
{
	...
	while (blocks--)
	{
		ft_sha512_make_w_arr(w, text);
		ft_memcpy(buf, hash, 64);
		ft_sha512_round(buf, w);
		words = 8;
		while (words--)
