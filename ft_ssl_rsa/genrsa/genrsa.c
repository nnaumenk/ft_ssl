...
void	ft_make_exponents(t_rsa_data *data, int exp_value_3)
{
	...
	ft_bigint_print("e is", &data->public_exponent);
	...
	{
		ft_printf("inverse error private_exponent\n");
		exit(0);
	}
	ft_bigint_del(&eiler);
	ft_printf("d\n");
	...
	{
		ft_printf("inverse error exponent1\n");
		exit(0);
	}
	if (ft_mod_inverse(&data->exponent2, &data->private_exponent, &data->prime2))
	{
		ft_printf("inverse error exponent2\n");
		exit(0);
	}
	...
	{
		ft_printf("inverse error coefficient\n");
		exit(0);
	}
}
